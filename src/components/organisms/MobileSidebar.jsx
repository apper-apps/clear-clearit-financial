...
className="fixed left-0 top-0 h-full w-80 bg-secondary border-r border-slate-200 z-50 lg:hidden flex flex-col"
          >
            {/* Header */}
...
<span className="text-header-bg font-bold text-lg">C</span>
            ...
            <nav className="flex-1 py-6 space-y-6 overflow-y-auto">
              {/* Core Navigation */}
              <div>
<h3 className="px-6 text-xs font-semibold text-text-secondary uppercase tracking-wide mb-3">
                  CORE
                </h3>
